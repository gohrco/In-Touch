<form action="addonmodules.php?module=intouch&action=groups&task=save" class="form-horizontal" method="post">
	<?php 
	...
	<div class="form-actions">
		...
		<a href="addonmodules.php?module=intouch&action=groups" class="btn btn-inverse pull-right span2"><?=t( 'intouch.form.close' )?></a>
	</div>
</form>